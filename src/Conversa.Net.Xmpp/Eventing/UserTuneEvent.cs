...
namespace Conversa.Net.Xmpp.Eventing
{
    ...
    /// </summary>
    public sealed class UserTuneEvent
        : UserEvent
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserTuneEvent">XmppUserTuneEvent</see> class.
        /// </summary>
        /// <param name="user">User contact</param>
        /// <param name="tune">User tune</param>
        public UserTuneEvent(string artist
                               , ushort length
                               , string rating
                               , string source
                               , string title
