...
namespace Conversa.Net.Xmpp.AdvancedMessageProcessing
{
    ...
    [XmlRootAttribute("unsupported-conditions", Namespace = "http://jabber.org/protocol/amp", IsNullable = false)]
    public partial class AmpUnsupportedConditions
    {
        ...
        public AmpUnsupportedConditions()
        {
